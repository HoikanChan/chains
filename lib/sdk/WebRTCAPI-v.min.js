...
var debugout=__webpack_require__(16)
...
var Constants = __webpack_require__(0)
var WebRTCStat = __webpack_require__(11)
var PingUtil = __webpack_require__(12)
var Util = __webpack_require__(4)
var RTCUtil = __webpack_require__(13)
var Report = __webpack_require__(17)
var MediaUtil = __webpack_require__(18)
var Log = __webpack_require__(2)
var DetectRTC = __webpack_require__(3)
var WebSocketClient = __webpack_require__(19)
var StreamHandler = __webpack_require__(20)
var Browser = __webpack_require__(21)
var Emitter = __webpack_require__(22)
var mitt = __webpack_require__(23)
var _ = __webpack_require__(24)
var jparam = __webpack_require__(26);
var SoundMeter = __webpack_require__(27)
var isMobile = __webpack_require__(28)
WebRTCStat.init();
...
WebRTCAPI.fn.getMediaByScreenShare = function(opts, succ , fail ){
    ...
    ScreenChromeExtensionUtil.getScreenConstraints( opts, function(error, screen_constraints) {
        ...
        console.debug('final_constraints',final_constraints)
...
WebRTCAPI.fn.updateConstraints = function(videoCtrlAbility , ext) {
    ...
    if( ext && ext.video && ext.video.deviceId){
        if( typeof global.constraints.video === 'object' && !( global.constraints.video instanceof Boolean)){
...
WebRTCAPI.fn.chooseVideoDevice = function( video ) {
    ...
    if( !global.enteredRoom ||  !global.peerConnection || !global.peerConnections[0]){
        return
    }
...
WebRTCAPI.fn.getStats = function ( opts , succ , error) {
    ...
    if( peer ){
        peer.getPeerStats( function( data ){
...
RTCUtil.fn.sendLocalCandidate = function (pc, srctinyid) {
  if (pc.localCandidateList.length === 0 || pc.hasSendCandidate) {
      return;
  }
...
/* WEBPACK VAR INJECTION */(function(global) {var Constants = __webpack_require__(0)
var DetectRTC = __webpack_require__(3)
var Util = __webpack_require__(4)
var Log = __webpack_require__(2)
...
MediaUtil.fn.packConstraints = function( constraints, opts, ext){
    ...
    if (new_constraints.video && opts && opts.video != false && opts.attributes) {
        if( typeof new_constraints.video !== 'object' || new_constraints.video instanceof Boolean){
            new_constraints.video = {};
        }
...
/* WEBPACK VAR INJECTION */(function(global) {var Log = __webpack_require__(2)
var Constants = __webpack_require__(0)
...
function addStreamStopListener(stream, callback) {
    ...
    var stream_listener = function(){
        if( stream.preventEvent ) return;
        callback({type: 'stream' });
    };

    var video_listener = function(){
        if( stream.preventEvent ) return;
        callback({type: 'video' });
    };

    var audio_listener = function(){
        if( stream.preventEvent ) return;
        callback({type: 'audio' });
    };
