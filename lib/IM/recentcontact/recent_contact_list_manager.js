                        ...
                        if(sessType == webim.SESSION_TYPE.GROUP){
                            getGroupInfo(sessionId,function(res){
                                if(res.GroupInfo[0].Type != 'ChatRoom'){
                                    addSess(webim.SESSION_TYPE.GROUP, webim.Tool.formatText2Html(res.GroupInfo[0].GroupId), webim.Tool.formatText2Html(res.GroupInfo[0].Name), '../assets/images/group.png', 0);
